    ...
    <form className="products-filter" onChange={addQueryParams}>
      ...
      <div className={`products-filter__wrapper ${filtersOpen ? 'products-filter__wrapper--open' : ''}`}>
        <div className="products-filter__block">
          <button type="button" style={{fontFamily: 'Montserrat-Regular'}}>Product type</button>
        ...
        <div className="products-filter__block">
          <button type="button" style={{fontFamily: 'Montserrat-Regular'}}>Price</button>
          <div className="products-filter__block__content">
        ...
        {/* <div className="products-filter__block">
          <button type="button" style={{fontFamily: 'Montserrat-Regular'}}>Color</button>
          <div className="products-filter__block__content">
